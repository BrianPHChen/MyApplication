...
object TestData {
    ...
    // Entity Models
    val sampleTaskEntity1 = TaskEntity(
        id = "1",
        title = "測試任務 1",
        description = "第一個測試任務的描述",
        isCompleted = false
    ...
    val sampleTaskEntity2 = TaskEntity(
        id = "2",
        title = "測試任務 2", 
        description = "第二個測試任務的描述",
        isCompleted = true
    ...
    val sampleTaskEntity3 = TaskEntity(
        id = "3",
        title = "測試任務 3",
        description = "第三個測試任務的描述", 
        isCompleted = false
    ...
    val sampleTaskEntities = listOf(sampleTaskEntity1, sampleTaskEntity2, sampleTaskEntity3)
